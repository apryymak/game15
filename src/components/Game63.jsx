...
const EMPTY_VALUE = 64 // Use 64 to represent empty space

const Game63 = ({ gameVersion, setGameVersion, theme }) => {
    ...
    // For a 63-puzzle (8x8):
    // If grid width is even (8), solvable if (inversions + rowFromBottom) is odd
    // where rowFromBottom is 1-indexed (1 = bottom row, 8 = top row)
    ...
    const shuffleTiles = () => {
        ...
        const numMoves = 400 + Math.floor(Math.random() * 400) // 400-800 random moves
    ...
    return (
        <div className="game-wrapper">
            <Theme theme={theme} />
            <div className="puzzle-container game-63">
                <GameSelector gameVersion={gameVersion} setGameVersion={setGameVersion} width={592} />
