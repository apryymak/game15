...
const Game24 = ({ gameVersion, setGameVersion }) => {
    ...
    // For a 25-puzzle (5x5):
    // If grid width is odd, solvable if inversions is even.
    const isSolvable = (arr) => {
        const inversions = countInversions(arr)
        // For odd grid sizes (like 5), polarity of inversions must be even
    ...
    const shuffleTiles = () => {
        ...
        const numMoves = 300 + Math.floor(Math.random() * 300) // 300-600 random moves
